   <h1 class="page-header">STUDENTS BONAFIDE CERTIFICATE GENERATION</h1>
   <div class="col-md-12">
    <div class="panel panel-default">
    <div class="panel-heading">
   <h3 class="panel-title">STUDENTS BONAFIDE CERTIFICATE</h3>
 </div>  
        <br>
  ...
  <table id="table" class="table table-bordered table-condensed">
    ...
    ?>
      <tr>
        ...
        <td>
	<a class="btn btn-info" onclick='window.open("form2.php?id=<?php echo $row['STUDENT_ID'] ?>")'>
	<i class="fa fa-fw fa-print"></i>PRINTABLE REPORT</a>
	</td>
       </tr>
      <?php
    }
