...
<head>
    ...
    <title>SIT STUDENT MANAGEMENT SYSTEM</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: orange">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="./images/sit.jpg"  width="5%">SIT STUDENT MANAGEMENT SYSTEM</b></a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color: orange">
            <?php 
            include 'db.php';
...
$page = $_GET['page'];
$pages = array('home', 'Students','form','view_placement','update_student_placement','student_placement','placement','subjects','student_p','records','record','addrecord','report','program','statistical','form137','list_report','student_report','users','college_academic_year','grade','advisers','database','candidates','candidates_list', 'candidates_report','logs');
if (!empty($page)) {
                    ...
                    <form action="rms.php?page=list_report" method="POST">
                      ...
                      <div class="col-sm-2">          
                       <select class="form-control" name="sy" id="pd">
                        ...
                        <?php
                        include 'db.php';
                        $query= mysqli_query($conn,"SELECT college_academic_year as sy FROM student_year_info GROUP BY college_academic_year Order By college_academic_year DESC");
